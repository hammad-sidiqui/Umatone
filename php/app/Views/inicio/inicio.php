                    ...
                    <div class="col-md-6" id="quiz" hidden>
                        ...
                        <div class="tab">
                            ...
                            <div class="btn-group" id="status" data-toggle="buttons" style="width:100%;margin-bottom: 20px;margin-top: 20px;">
                                <label class="btn btn-default btn-off btn-lg">
                                <input type="radio" value="Imperial" name="check_per">Imperial</label>
                                <label class="btn btn-default btn-off btn-lg">
                        ...
                        <div class="tab">
                          ...
                          <div class="btn-group" id="status" data-toggle="buttons" style="width:100%;margin-bottom: 20px;margin-top: 20px;">
                            <label class="btn btn-default btn-off btn-lg">
                            <input type="radio" value="Imperial" name="check_per1" id="check41" >Imperial</label>
                            <label class="btn btn-default btn-off btn-lg">
                          ...
                          <div class="row">
                            <div class="col">
                              ...
                              <p class="ico" style="position: relative;">
                                <input type="text" placeholder="00 (cm)" name="alt" onKeyPress="return soloNumeros(event)" maxlength="3">
                                <span  class="" style="position: absolute;right:15px;top: 15px;"></span>
                              </p>
                            </div>
...
function validateForm() {
    ...
    $(".tab:eq("+currentTab+") input").each(function(){
        ...
        if ($(this).attr('type')=='checkbox') {
            ...
            if(($(this).attr('name')=="check1" || $(this).attr('name')=="check2") && $(this).prop('checked')==false ){
