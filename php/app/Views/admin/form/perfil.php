								...
								<div class="col-md-8">
									...
									<div class="row">
        								...
        								<div class="mb-3 col-md-6">
        									...
        									<input type="text" class="form-control" name="ape" value="<?=$ape?>" required>
        								</div>
        							</div>
									<div class="row">
        								<div class="mb-3 col-md-6">
        									<label class="form-label" for="inputFirstName">Email address</label>
        									<input type="email" class="form-control" name="ema" value="<?=$ema?>" required>
        								</div>
                        <div class="mb-3 col-md-6">
        									<label class="form-label" for="inputFirstName">Telephone</label>
        									<input type="text" class="form-control" name="tel" value="<?=$tel?>" onkeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" maxlength="15" required>
        								</div>
        							</div>
        							<div class="row">
                        <div class="mb-3 col-md-6">
